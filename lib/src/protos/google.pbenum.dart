...
class CardAuthMethods extends $pb.ProtobufEnum {
  static const CardAuthMethods PAN_ONLY = CardAuthMethods._(
      0,
...
class BillingFormat extends $pb.ProtobufEnum {
  static const BillingFormat MIN = BillingFormat._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MIN');
  static const BillingFormat FULL = BillingFormat._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FULL');
  ...
  static final $core.Map<$core.int, BillingFormat> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class CheckoutOption extends $pb.ProtobufEnum {
  static const CheckoutOption DEFAULT = CheckoutOption._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DEFAULT');
  static const CheckoutOption COMPLETE_IMMEDIATE_PURCHASE = CheckoutOption._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
  ...
  static final $core.Map<$core.int, CheckoutOption> _byValue =
      $pb.ProtobufEnum.initByValue(values);
