...
final $typed_data.Uint8List billingFormatDescriptor =
    $convert.base64Decode('Cg1CaWxsaW5nRm9ybWF0EgcKA01JThAAEggKBEZVTEwQAQ==');
...
final $typed_data.Uint8List checkoutOptionDescriptor = $convert.base64Decode(
    'Cg5DaGVja291dE9wdGlvbhILCgdERUZBVUxUEAASHwobQ09NUExFVEVfSU1NRURJQVRFX1BVUkNIQVNFEAE=');
...
const CardParameters$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'allow_prepaid_cards',
      '3': 2,
      '4': 1,
      '5': 8,
      '10': 'allowPrepaidCards'
    },
    const {
      '1': 'allow_credit_cards',
      '3': 3,
      '4': 1,
      '5': 8,
      '10': 'allowCreditCards'
    ...
    const {
      '1': 'assurance_details_required',
      '3': 4,
      '4': 1,
      '5': 8,
      '10': 'assuranceDetailsRequired'
    },
    const {
      '1': 'billing_address_required',
      '3': 5,
      '4': 1,
      '5': 8,
      '10': 'billingAddressRequired'
    },
    const {
      '1': 'billing_address_parameters',
      '3': 6,
      '4': 1,
      '5': 11,
      '6': '.google.BillingAddressParameters',
...
final $typed_data.Uint8List cardParametersDescriptor = $convert.base64Decode(
    '');
...
const BillingAddressParameters$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 8,
      '10': 'phoneNumberRequired'
    },
  ],
};

/// Descriptor for `BillingAddressParameters`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List billingAddressParametersDescriptor =
    $convert.base64Decode(
        'ChhCaWxsaW5nQWRkcmVzc1BhcmFtZXRlcnMSPAoOYmlsbGluZ19mb3JtYXQYASABKA4yFS5nb29nbGUuQmlsbGluZ0Zvcm1hdFINYmlsbGluZ0Zvcm1hdBIyChVwaG9uZV9udW1iZXJfcmVxdWlyZWQYAiABKAhSE3Bob25lTnVtYmVyUmVxdWlyZWQ=');
...
const TransactionInfo$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'total_price_status',
      '3': 2,
      '4': 1,
      '5': 14,
      '6': '.google.TotalPriceStatus',
      '10': 'totalPriceStatus'
    },
    const {
      '1': 'total_price_label',
...
final $typed_data.Uint8List transactionInfoDescriptor = $convert.base64Decode(
    '');
...
const ShippingAddressParameters$json = const {
  ...
  '2': const [
    const {
      '1': 'allowed_country_codes',
      '3': 1,
      '4': 3,
      '5': 9,
      '10': 'allowedCountryCodes'
    },
    const {
      '1': 'phone_number_required',
      '3': 2,
...
final $typed_data.Uint8List shippingAddressParametersDescriptor =
    $convert.base64Decode(
        'ChlTaGlwcGluZ0FkZHJlc3NQYXJhbWV0ZXJzEjIKFWFsbG93ZWRfY291bnRyeV9jb2RlcxgBIAMoCVITYWxsb3dlZENvdW50cnlDb2RlcxIyChVwaG9uZV9udW1iZXJfcmVxdWlyZWQYAiABKAhSE3Bob25lTnVtYmVyUmVxdWlyZWQ=');
