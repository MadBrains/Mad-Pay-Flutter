...
const PaymentNetwork$json = const {
  ...
  '2': const [
    ...
    const {'1': 'SUICA', '2': 17},
    const {'1': 'VPAY', '2': 18},
    const {'1': 'DANKORT', '2': 19},
    const {'1': 'NANACO', '2': 21},
    const {'1': 'WAON', '2': 22},
    const {'1': 'GIROCARD', '2': 23},
    const {'1': 'BARCODE', '2': 24},
  ],
};
...
final $typed_data.Uint8List paymentNetworkDescriptor = $convert.base64Decode(
    '');
