...
class PaymentItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentItem', createEmptyInstance: create)
  ...
  factory PaymentItem.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PaymentItem.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  PaymentItem copyWith(void Function(PaymentItem) updates) => super.copyWith((message) => updates(message as PaymentItem)) as PaymentItem; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static PaymentItem getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PaymentItem>(create);
...
enum PaymentRequest_Parameters {
  google, 
  apple, 
  notSet
}
...
class PaymentRequest extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, PaymentRequest_Parameters> _PaymentRequest_ParametersByTag = {
    1 : PaymentRequest_Parameters.google,
    2 : PaymentRequest_Parameters.apple,
    0 : PaymentRequest_Parameters.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentRequest', createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.GoogleParameters>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'google', subBuilder: $0.GoogleParameters.create)
    ..aOM<$1.AppleParameters>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apple', subBuilder: $1.AppleParameters.create)
  ...
  PaymentRequest_Parameters whichParameters() => _PaymentRequest_ParametersByTag[$_whichOneof(0)]!;
  void clearParameters() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  $0.GoogleParameters get google => $_getN(0);
  @$pb.TagNumber(1)
  set google($0.GoogleParameters v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set apple($1.AppleParameters v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class EnvironmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EnvironmentRequest', createEmptyInstance: create)
    ..e<PaymentEnvironment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment', $pb.PbFieldType.OE, defaultOrMaker: PaymentEnvironment.TEST, valueOf: PaymentEnvironment.valueOf, enumValues: PaymentEnvironment.values)
    ..hasRequiredFields = false
  ;
  ...
  factory EnvironmentRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EnvironmentRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EnvironmentRequest copyWith(void Function(EnvironmentRequest) updates) => super.copyWith((message) => updates(message as EnvironmentRequest)) as EnvironmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EnvironmentRequest create() => EnvironmentRequest._();
  EnvironmentRequest createEmptyInstance() => create();
  static $pb.PbList<EnvironmentRequest> createRepeated() => $pb.PbList<EnvironmentRequest>();
  @$core.pragma('dart2js:noInline')
  static EnvironmentRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EnvironmentRequest>(create);
  static EnvironmentRequest? _defaultInstance;

  @$pb.TagNumber(1)
  PaymentEnvironment get environment => $_getN(0);
  @$pb.TagNumber(1)
  set environment(PaymentEnvironment v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class CheckActiveCardRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CheckActiveCardRequest', createEmptyInstance: create)
    ..pc<PaymentNetwork>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedPaymentNetworks', $pb.PbFieldType.PE, valueOf: PaymentNetwork.valueOf, enumValues: PaymentNetwork.values)
    ..hasRequiredFields = false
  ;
  ...
  factory CheckActiveCardRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CheckActiveCardRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CheckActiveCardRequest clone() => CheckActiveCardRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CheckActiveCardRequest copyWith(void Function(CheckActiveCardRequest) updates) => super.copyWith((message) => updates(message as CheckActiveCardRequest)) as CheckActiveCardRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CheckActiveCardRequest create() => CheckActiveCardRequest._();
  CheckActiveCardRequest createEmptyInstance() => create();
  static $pb.PbList<CheckActiveCardRequest> createRepeated() => $pb.PbList<CheckActiveCardRequest>();
  @$core.pragma('dart2js:noInline')
  static CheckActiveCardRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CheckActiveCardRequest>(create);
