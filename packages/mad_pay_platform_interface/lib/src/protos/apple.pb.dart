...
class AppleParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppleParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'apple'), createEmptyInstance: create)
    ...
    ..e<MerchantCapabilities>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'merchantCapabilities', $pb.PbFieldType.OE, defaultOrMaker: MerchantCapabilities.THREEDS, valueOf: MerchantCapabilities.valueOf, enumValues: MerchantCapabilities.values)
  ...
  @$pb.TagNumber(2)
  set merchantCapabilities(MerchantCapabilities v) { setField(2, v); }
  @$pb.TagNumber(2)
